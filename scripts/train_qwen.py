...
def build_dataset(raw_data, tokenizer, max_length, name):
    ...
    # Large drop rates silently bias training toward shorter/easier samples.
...
class ExtractionTrainer(Trainer):
    ...
    def evaluate(
        ...
        # Keep ordinary eval_loss for diagnostics.
        ...
        # Add the metric that actually matches the downstream task.
...
class TrainInfoCallback(TrainerCallback):
    def on_train_begin(self, args, state, control, **kwargs):
        ...
        print()
        print("=" * 72)
        print("3-field LoRA SFT started")
        print("=" * 72)
...
def main():
    ...
    try:
        ...
        if trainer.is_world_process_zero():
            ...
            print()
            print("=" * 72)
            print("3-field LoRA training completed")
            print("=" * 72)
