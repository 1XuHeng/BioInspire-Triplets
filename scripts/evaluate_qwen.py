...
ADAPTER_PATH = "./outputs/qwen/lora/final_adapter"
# ADAPTER_PATH = None

TEST_FILE = "./data/test.json"

OUTPUT_DIR = "./outputs/qwen/lora_infer"
# OUTPUT_DIR = "./outputs/qwen/base_infer"
...
def compute_extraction_metrics(
    ...
    for example, pred_text in zip(
        ...
        # ========================================
        # 1. Source / Prototype / Application
        #    按 relation occurrence 统计
        # ========================================
        for kind in [
            "source",
            "prototype",
...
def main():
    ...
    try:
        ...
        if rank == 0:
            ...
            print(
                f"Thinking mode : {ENABLE_THINKING}"
            )
